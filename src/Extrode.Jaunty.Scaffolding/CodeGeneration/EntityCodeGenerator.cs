...
namespace Extrode.Jaunty.Scaffolding.CodeGeneration;
...
public sealed class EntityCodeGenerator : ICodeGenerator
{
    ...
    private void AppendUsings(StringBuilder sb, TableSchema table, CodeGeneratorOptions options)
    {
        ...
        // Extrode.Jaunty's own [Table]/[Column]/[Key]/[DatabaseGenerated] attributes are emitted fully
    ...
    private static void AppendClassAttributes(StringBuilder sb, TableSchema table, CodeGeneratorOptions options, string indent)
    {
        ...
        // but it is not redundant to Extrode.Jaunty.SourceGenerator, whose GetSemanticTargetForGeneration
    ...
    /// <code>
    ///     [Extrode.Jaunty.Attributes.Column("line1
    ///     line2")]
    /// </code>
