...
/// threw before reaching any Extrode.Jaunty code:
/// </para>
/// <code>
...
/// </para>
/// <para>
/// <b>Why this is Extrode.Jaunty.Fluent's problem even though the throw is in consumer code.</b> The whole
...
/// to know that comparing one of the most ordinary column types requires a trimmer directive. Extrode.Jaunty
/// asks for the expression tree, so Extrode.Jaunty arranges for it to be constructible; the same reasoning as
/// spec 011, where Extrode.Jaunty reflects over parameter objects and so arranges their preservation.
/// </para>
/// <para>
