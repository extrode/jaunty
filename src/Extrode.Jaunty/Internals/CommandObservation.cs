...
namespace Extrode.Jaunty.Internals;

/// <summary>
/// The single place anything in Extrode.Jaunty decides whether a command is being observed, and the single
...
/// <see cref="InterceptorPipeline.IsObserved"/> so that subscribing to the "Extrode.Jaunty"
...
/// Extrode.Jaunty API: thirty call sites tested <c>HasInterceptors</c> and returned early, so the pipeline
...
/// </description></item>
/// <item><description>
/// <b>Whole assemblies were invisible.</b> Extrode.Jaunty.Fluent and the FlatFiles assemblies contained
...
internal static class CommandObservation
{
    ...
    /// </para>
    /// <para>
    /// Materialising the listener singleton here is also what makes Extrode.Jaunty discoverable: a
    /// <c>DiagnosticListener.AllListeners</c> observer cannot see the "Extrode.Jaunty" source until
