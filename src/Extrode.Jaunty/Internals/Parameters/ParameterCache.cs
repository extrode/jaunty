...
internal static class ParameterCache
{
    ...
    /// by generated rooting; see <c>Extrode.Jaunty.JauntyAot</c> and <c>JAUNTYGEN003</c>.
    /// </remarks>
    ...
    private static ParameterMetadata[] BuildMetadata(Type type)
    {
        ...
        foreach (PropertyInfo p in props)
        {
            ...
            // readable", an error naming neither Extrode.Jaunty, the type nor the property. A property
