...
public sealed class BulkCopyOptions
{
    ...
    /// <remarks>
    /// <para>
    /// <b>AUD-R26-061: currently has no effect on any provider, including SQL Server.</b> Extrode.Jaunty's
    ...
    /// <c>BulkCopyConfiguration.DefaultCheckConstraints</c>. Extrode.Jaunty's own callers always assign it
