...
namespace Extrode.Jaunty.Internals.BulkCopy;
...
internal sealed class EntityDataReader<T> : IDataReader where T : new()
{
    ...
    /// whose per-cell access pattern Extrode.Jaunty does not control. That is the same third-party-contract
    ...
    /// every other column-name lookup in Extrode.Jaunty is deliberately case-insensitive
    ...
    /// to third-party provider bulk-copy APIs whose lookup behaviour Extrode.Jaunty does not control.
    /// </remarks>
