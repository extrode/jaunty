...
/// <summary>
/// Common constants and cached values used throughout Extrode.Jaunty.
/// </summary>
internal static class CommonConstants
{
    /// <summary>
    /// The one case-insensitive string comparer Extrode.Jaunty keys its name lookups with - column names,
