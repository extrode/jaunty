...
/// <remarks>
/// <para>
/// AUD-R26 (batch 4, medium/bug). Extrode.Jaunty derives a lot from a handful of configuration delegates:
...
/// <c>Extrode.Jaunty.Init.cs</c> - "call UseReflectionMapping() at startup" - carried the same unstated
