...
/// <remarks>
/// <para>
/// Spec 011. Extrode.Jaunty reads a parameters object by reflecting over its public properties
...
/// </list>
/// <para>
/// <strong>Most consumers never need to call these.</strong> The Extrode.Jaunty source generator inspects
...
/// that references Extrode.Jaunty without the analyzer. The generator reports <c>JAUNTYGEN003</c> when it
...
public static class JauntyAot
{
    ...
    /// </typeparam>
    /// <param name="parameters">The parameters object being passed to a Extrode.Jaunty API.</param>
    ...
    /// it can be used as Extrode.Jaunty parameters objects anywhere in the program.
    /// </summary>
