...
public static partial class Jaunty
{
    ...
    /// and the simple <see cref="global::Extrode.Jaunty.Configuration.JauntyConfig.Logger"/> callback, the same as
    /// buffered queries, but they do NOT currently pass through the registered
    /// <see cref="global::Extrode.Jaunty.Interceptors.ICommandInterceptor"/> pipeline. Wiring pipeline interceptors into
