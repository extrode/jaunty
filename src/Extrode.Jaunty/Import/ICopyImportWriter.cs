...
namespace Extrode.Jaunty.Import;

/// <summary>
/// A provider's client-side bulk-copy stream, as Extrode.Jaunty needs to use it: something to write CSV
/// text into, and a way to abort rather than commit what has been written.
/// </summary>
/// <remarks>
/// <para>
/// This exists so that core does not have to reach a provider's copy API by reflection. Extrode.Jaunty
