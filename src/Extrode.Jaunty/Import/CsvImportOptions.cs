...
public class CsvImportOptions
{
    ...
    /// <list type="bullet">
    /// <item><description>
    /// <b>SQLite, in-memory</b> - honored. Extrode.Jaunty parses the file and binds the values itself.
    /// </description></item>
    /// <item><description>
    ...
    /// <remarks>
    /// <para>
    /// Honored only where Extrode.Jaunty opens the file. Elsewhere the database engine or its driver opens
