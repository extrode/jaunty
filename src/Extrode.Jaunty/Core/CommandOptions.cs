...
/// <remarks>
/// <para>
/// This struct provides configuration options for database command execution in Extrode.Jaunty.
    ...
    int? commandTimeout = null, CommandType commandType = CommandType.Text, int? expectedRowCount = null)
{
    ...
    /// </remarks>
    public readonly int? CommandTimeout = global::Extrode.Jaunty.Internals.CommandTimeoutHint.Require(commandTimeout);
    ...
    /// </para>
    /// </remarks>
    public readonly int? ExpectedRowCount = global::Extrode.Jaunty.Internals.CapacityHint.Normalize(expectedRowCount);
