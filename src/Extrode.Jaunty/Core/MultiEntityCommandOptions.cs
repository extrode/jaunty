    ...
    where T2 : new()
{
    ...
    public MultiEntityCommandOptions(IDbTransaction? transaction = null, int? commandTimeout = null, CommandType commandType = CommandType.Text, int? expectedRowCount = null)
    {
        ...
        CommandTimeout = global::Extrode.Jaunty.Internals.CommandTimeoutHint.Require(commandTimeout);
        CommandType = commandType;
        ExpectedRowCount = global::Extrode.Jaunty.Internals.CapacityHint.Normalize(expectedRowCount);
    }
