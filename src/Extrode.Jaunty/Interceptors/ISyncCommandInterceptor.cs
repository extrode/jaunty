...
/// <remarks>
/// <para>
/// When Extrode.Jaunty's <em>synchronous</em> APIs (for example <c>Query&lt;T&gt;</c> or
...
/// </para>
/// <para>
/// Extrode.Jaunty's built-in interceptors (<c>LoggingInterceptor</c>, <c>AuditInterceptor</c>)
