...
public interface ISqlDialect
{
    ...
    /// </summary>
    /// <remarks>
    /// Extrode.Jaunty never emits this value, and it must never be used to fill in a missing schema.
    ...
    /// <remarks>
    /// <para>
    /// <b>Honored by <c>Extrode.Jaunty.Fluent</c> only.</b> Every fluent builder consults this property when
    /// composing placeholders. Extrode.Jaunty core's own CRUD and by-id paths do not: <c>CrudSqlCache</c>,
    ...
    /// <c>Extrode.Jaunty.Extensions.Reflection</c>'s equivalents.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// <b>Extrode.Jaunty.Fluent is not a workaround for this.</b> It honours the prefix, so its SQL parses,
