...
/// comment here and in three places in Extrode.Jaunty.Scaffolding - that SQLite had no schemas. The
...
internal sealed class SQLiteDialect : ISqlDialect, ISubstringToEndDialect, IDecimalBindingDialect
{
    ...
    /// <summary>
    /// SQLite's <c>SQLITE_MAX_VARIABLE_NUMBER</c>, 32,766 on every build Extrode.Jaunty ships against.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// rather than only as a batch-sizing hint, Extrode.Jaunty refused <c>IN</c>-clause expansions the
    ...
    /// Extrode.Jaunty's message. That trade is deliberate: refusing valid queries for everyone is worse than
