namespace Extrode.Jaunty.Attributes;
...
/// If not specified, Extrode.Jaunty will use the property name as the column name.
/// </para>
/// <para>
/// This attribute is Extrode.Jaunty's native column mapping attribute. It also supports the standard
