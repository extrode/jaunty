...
/// If not specified, Extrode.Jaunty will use the class name as the table name.
/// </para>
/// <para>
/// This attribute is Extrode.Jaunty's native table mapping attribute. It also supports the standard
