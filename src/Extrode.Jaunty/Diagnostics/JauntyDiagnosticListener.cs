...
namespace Extrode.Jaunty.Diagnostics;

/// <summary>
/// Emits diagnostic events for Extrode.Jaunty command execution.
/// </summary>
/// <remarks>
/// <para>
...
{
    /// <summary>
    /// The name of the DiagnosticSource used by Extrode.Jaunty.
    /// </summary>
    public const string DiagnosticSourceName = "Extrode.Jaunty";

    /// <summary>
    /// Event name emitted before command execution.
    /// </summary>
    public const string CommandExecutingEventName = "Extrode.Jaunty.Database.Command.Executing";

    /// <summary>
    /// Event name emitted after successful command execution.
    /// </summary>
    public const string CommandExecutedEventName = "Extrode.Jaunty.Database.Command.Executed";

    /// <summary>
    /// Event name emitted when command execution fails.
    /// </summary>
    public const string CommandFailedEventName = "Extrode.Jaunty.Database.Command.Failed";
