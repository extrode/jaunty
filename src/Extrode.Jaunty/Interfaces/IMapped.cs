...
/// instead of relying on Extrode.Jaunty's automatic property-to-column mapping. This is useful for:
/// </para>
/// <list type="bullet">
...
public interface IMapped<T> where T : new()
{
    ...
    /// <remarks>
    /// <para>
    /// This static method is called by Extrode.Jaunty to map a row from the database to an entity instance.
    ...
    /// <remarks>
    /// <para>
    /// This instance method is called by Extrode.Jaunty to map a row from the database to an entity instance.
    /// The reader is positioned on the row to read when this method is called.
    /// </para>
    /// <para>
