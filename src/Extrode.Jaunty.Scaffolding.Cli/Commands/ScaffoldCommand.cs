...
internal sealed class ScaffoldCommand : Command
{
    public ScaffoldCommand() : base("scaffold", "Generate entity classes from database schema")
    {
        ...
        // compose with Extrode.Jaunty.SourceGenerator, which emits a partial declaration of its own for any
        ...
        {
            Description = "Don't generate partial classes (they will not compose with Extrode.Jaunty.SourceGenerator)"
        };
