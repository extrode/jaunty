...
internal static class NonQueryExecutor
{
    ...
    internal static void ApplyOptions(DuckDBCommand cmd, CommandOptions options)
    {
        ...
        // (mirroring Extrode.Jaunty core's GetByIdSimpleCoreDirect) for a clear ArgumentException instead.
        ...
        if (options.Transaction is not null)
            ((IDbCommand)cmd).Transaction = global::Extrode.Jaunty.AsyncTransactionValidator.RequireDbTransaction(options.Transaction);
