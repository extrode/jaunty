...
/// <c>Extrode.Jaunty.FlatFiles</c> nor <c>Extrode.Jaunty.FlatFiles.DuckDB</c> contained a single reference to
...
/// command", jointly with the same gap in Extrode.Jaunty.Fluent and in core's write paths. That helper is
/// <c>Extrode.Jaunty.Internals.CommandObservation</c>, reachable here through the <c>InternalsVisibleTo</c>
/// grant Extrode.Jaunty core already gave this assembly.
/// </para>
/// <para>
...
internal static class DuckDbObservation
{
    ...
    /// <summary>The command type every DuckDB statement Extrode.Jaunty issues carries.</summary>
