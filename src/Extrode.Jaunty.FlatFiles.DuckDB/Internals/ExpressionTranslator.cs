...
internal static class ExpressionTranslator
{
    ...
    /// Extrode.Jaunty.Fluent's WhereExpressionVisitor had the identical omission and is fixed alongside this.
    ///
    /// <para>
    ...
    ///
    /// <para>
    /// Extrode.Jaunty.Fluent's <c>ExpressionEvaluator</c> carries the same logic for the seven copies that
