...
/// <summary>
/// Provides extension methods for registering Extrode.Jaunty logging and interceptors with dependency injection.
/// </summary>
/// <remarks>
/// <para>
/// This class enables easy integration of Extrode.Jaunty's interceptors with
...
{
    /// <summary>
    /// Adds Extrode.Jaunty logging to the service collection.
    /// </summary>
    ...
    /// and adds it to the Extrode.Jaunty interceptor pipeline when <see cref="ApplyJauntyInterceptors(IServiceProvider)"/> is called.
    /// </para>
    /// <para>
    ...
    /// <summary>
    /// Applies all registered interceptors to the Extrode.Jaunty configuration.
    /// </summary>
    /// <param name="serviceProvider">The service provider.</param>
    /// <remarks>
    /// Call this method after building the service provider to apply interceptors to Extrode.Jaunty.
