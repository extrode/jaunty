...
internal static class MetadataBuilder
{
    ...
    public static EntityMetadata Build<T>()
    {
        ...
        for (var i = 0; i < props.Length; i++)
        {
            ...
            // exists, which means adding or removing the Extrode.Jaunty.SourceGenerator package reference
            ...
            else
            {
                ...
                if (dataGenAttr is not null)
                {
                    ...
                    {
                        // Map System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption to Extrode.Jaunty.Attributes.DatabaseGeneratedOption
    ...
    /// <c>GetMappableProperties</c> and <c>MappedPropertyFilter</c> in Extrode.Jaunty.FlatFiles.DuckDB both
