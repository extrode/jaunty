...
namespace Extrode.Jaunty.Extensions.Reflection;

/// <summary>
/// Provides reflection-based fallback mapping for Extrode.Jaunty.
/// </summary>
/// <remarks>
...
public static class JauntyReflectionExtensions
{
    ...
    /// This method configures Extrode.Jaunty to use database-specific bulk copy APIs
    ...
    // under; see Extrode.Jaunty.Internals.ConfigurationGeneration.
        ...
        if (underlyingType.IsEnum)
        {
            ...
            if (enumAttr is not null)
            {
                return enumAttr.Storage == EnumStorage.String
                    ...
                    : value => ConvertWithTypeHandlerOrElse(value, static v => global::Extrode.Jaunty.Core.GeneratedBindingSupport.ToDbEnumValue(v, EnumStorage.Numeric));
            }

            return value => ConvertWithTypeHandlerOrElse(value, static v =>
                JauntyConfig.DefaultEnumStorage == EnumStorage.String ? v.ToString() : global::Extrode.Jaunty.Core.GeneratedBindingSupport.ToDbEnumValue(v, EnumStorage.Numeric));
        }
    ...
    /// benefit never collected. Core Extrode.Jaunty already treats reflection <c>GetValue</c> as the
