...
namespace Extrode.Jaunty.Extensions.Reflection.Dialects;
...
internal sealed class SQLiteDialectWithBulkCopy : ISqlDialect, ISubstringToEndDialect, IDecimalBindingDialect, IDialectWrapper
{
    ...
    /// BulkInsert's SQLite routing) still see SQLiteDialect once UseNativeBulkCopy()
    ...
    /// substring one: installing <c>Extrode.Jaunty.Extensions.Reflection</c> would quietly reintroduce the
