...
internal sealed class SqlServerBulkCopyProvider : IBulkCopyProvider
{
    ...
    {
        global::Extrode.Jaunty.Dialects.SqlIdentifierValidator.Validate(tableName, nameof(tableName), global::Extrode.Jaunty.Dialects.SqlIdentifierFlavor.SqlServer);
        if (schemaName is null || schemaName.Length == 0)
            return tableName;

        global::Extrode.Jaunty.Dialects.SqlIdentifierValidator.Validate(schemaName, nameof(schemaName), global::Extrode.Jaunty.Dialects.SqlIdentifierFlavor.SqlServer);
