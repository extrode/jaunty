...
internal sealed class MySqlBulkCopyProvider : IBulkCopyProvider
{
    ...
    {
        global::Extrode.Jaunty.Dialects.SqlIdentifierValidator.Validate(tableName, nameof(tableName), global::Extrode.Jaunty.Dialects.SqlIdentifierFlavor.MySql);
        if (schemaName is not null && schemaName.Length != 0)
            global::Extrode.Jaunty.Dialects.SqlIdentifierValidator.Validate(schemaName, nameof(schemaName), global::Extrode.Jaunty.Dialects.SqlIdentifierFlavor.MySql);
        foreach (string columnName in columnNames)
            global::Extrode.Jaunty.Dialects.SqlIdentifierValidator.Validate(columnName, nameof(columnNames), global::Extrode.Jaunty.Dialects.SqlIdentifierFlavor.MySql);
