...
public static partial class Jaunty
{
    ...
    public static async Task<T?> QueryFirstOrDefaultAsync<T>(this IDbConnection connection, string sql, CommandOptions options) where T : new()
    {
        return await QueryFirstOrDefaultCoreAsync<T>(connection, sql, null, options, MappingMode.Strict);
    }

    public static async Task<T?> QueryFirstOrDefaultAsync<T>(this IDbConnection connection, string sql, object parameters, CommandOptions options) where T : new()
    {
