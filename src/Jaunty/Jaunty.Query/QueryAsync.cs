...
public static partial class Jaunty
{
    ...
    {
        return QueryCoreAsync<T>(connection, sql, null, default, MappingMode.Strict, null, cancellationToken);
    }
    ...
    {
        return QueryCoreAsync<T>(connection, sql, parameters, default, MappingMode.Strict, null, cancellationToken);
    }
    ...
    {
        return QueryCoreAsync<T>(connection, sql, null, options, MappingMode.Strict, null, cancellationToken);
    }
    ...
    {
        return QueryCoreAsync<T>(connection, sql, parameters, options, MappingMode.Strict, null, cancellationToken);
    }
    ...
    {
        return QueryCoreAsync<T>(connection, sql, CombineParams(param1, param2, rest), default, MappingMode.Strict, null, default);
    }
}
