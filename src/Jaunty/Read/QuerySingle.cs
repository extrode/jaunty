...
public static partial class Jaunty
{
    ...
    /// <see cref="QuerySingleOrDefault{T}(IDbConnection, string)"/>.
    /// </para>
    /// </remarks>
    /// <example>
    /// <code>
    ...
    /// }
    /// 
    /// // Get single product by ID (must exist and be unique)
    ...
    /// <seealso cref="QuerySingleAsync{T}(IDbConnection, string)"/>
    ...
    /// <seealso cref="QuerySingleOrDefault{T}(IDbConnection, string, object)"/>
