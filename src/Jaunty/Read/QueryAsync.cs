...
{
    /// <summary>
    /// Executes a query asynchronously and returns the results as a list of entities.
    ...
    /// <summary>
    /// Executes a query with parameters asynchronously and returns the results as a list of entities.
    /// Uses strict mapping mode where all entity properties must have matching columns in the result set.
    /// </summary>
    /// <typeparam name="T">The entity type.</typeparam>
    /// <param name="connection">The database connection.</param>
    ...
    /// <summary>
    /// Executes a query with command options asynchronously and returns the results as a list of entities.
    /// Uses strict mapping mode where all entity properties must have matching columns in the result set.
    /// </summary>
    /// <typeparam name="T">The entity type.</typeparam>
    /// <param name="connection">The database connection.</param>
    ...
    /// <summary>
    /// Executes a query with parameters and command options asynchronously and returns the results as a list of entities.
    /// Uses strict mapping mode where all entity properties must have matching columns in the result set.
    /// </summary>
    /// <typeparam name="T">The entity type.</typeparam>
    /// <param name="connection">The database connection.</param>
