        ...
        CancellationToken cancellationToken) where T : new()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                int providerResult = await bulkProvider.CopyToServerAsync(connection, cached.Metadata.TableName, reader, bulkOptions, cancellationToken).ConfigureAwait(false);
