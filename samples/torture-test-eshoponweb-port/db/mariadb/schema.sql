-- Reference DDL for the eShopOnWeb Jaunty torture-test (MariaDB 11).
-- MariaDB shares the MySQL DDL dialect; runtime schema creation is done by the same embedded
-- C# DDL in src/Infrastructure/Data/Persistence/MySqlSchema.cs. Column shapes mirror Rows.cs.
