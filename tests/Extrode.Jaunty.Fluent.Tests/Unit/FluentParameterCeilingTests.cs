...
/// <c>Extrode.Jaunty.Tests/Unit/Dialects/SqliteParameterCeilingTests.cs</c>.
/// </para>
/// </summary>
public class FluentParameterCeilingTests : IClassFixture<FluentDatabaseFixture>
{
    ...
    /// <summary>
    /// Past the real ceiling, the two Fluent routes now refuse in Extrode.Jaunty's own words instead of
