...
/// dialect. <see cref="Extrode.Jaunty.Dialects.SqlDialectFactory.GetDialect"/> resolves purely on
...
/// <see cref="Extrode.Jaunty.Dialects.SqlDialectFactory"/>'s name-based resolution picks the real
