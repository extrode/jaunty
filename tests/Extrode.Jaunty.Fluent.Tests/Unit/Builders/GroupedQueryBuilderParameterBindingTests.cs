...
/// for consumption by Extrode.Jaunty's core reflection-based binder - but this method binds directly to a
...
/// BindParameters method via reflection (the class is internal but Extrode.Jaunty.Fluent.Tests has
