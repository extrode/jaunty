...
public class ProjectionRootingTests
{
    ...
    public void TheMapperEntryPointsRootTheirProjectionType()
    {
        ...
        Type mapper = fluent.GetType("Extrode.Jaunty.Fluent.Internals.GroupedJoinedResultMapper", throwOnError: true)!;
        Type plan = fluent.GetType("Extrode.Jaunty.Fluent.Internals.GroupedJoinedResultMapper+ResultMapperPlan", throwOnError: true)!;
