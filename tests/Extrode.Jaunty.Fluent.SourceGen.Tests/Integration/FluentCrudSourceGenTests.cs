...
/// Extrode.Jaunty.Extensions.Reflection at all (see the .csproj). Skips per-dialect if the
/// corresponding JAUNTY_TEST_* connection string env var isn't set, matching
/// Extrode.Jaunty.Tests' existing convention for optional real-database coverage.
/// </summary>
public sealed class FluentCrudSourceGenTests
{
    ...
    // Natural (non-identity) key, matching Extrode.Jaunty.Tests' UpsertTests.cs convention - see
