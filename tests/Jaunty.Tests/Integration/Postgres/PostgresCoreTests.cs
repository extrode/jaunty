...
namespace Jaunty.Tests.Integration.Postgres;

/// <summary>
/// Core integration tests against PostgreSQL.
/// PostgreSQL uses LIMIT syntax and returns long from COUNT(*).
/// </summary>
public class PostgresCoreTests : CoreIntegrationTestBase
{
