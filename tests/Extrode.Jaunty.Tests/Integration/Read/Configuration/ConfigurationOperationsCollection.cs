...
namespace Extrode.Jaunty.Tests.Integration.Read.Configuration;

/// <summary>
/// Test collection for tests that mutate the process-wide static
/// <see cref="Extrode.Jaunty.Configuration.JauntyConfig.ColumnNameResolver"/> /
/// <see cref="Extrode.Jaunty.Configuration.JauntyConfig.TableNameResolver"/>.
