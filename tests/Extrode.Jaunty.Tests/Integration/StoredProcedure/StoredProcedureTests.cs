...
namespace Extrode.Jaunty.Tests.Integration.StoredProcedure;
...
public class StoredProcedureTests : IClassFixture<DialectFixture>
{
    ...
    // IDbTransaction on a real DbConnection threw an opaque InvalidCastException instead of Extrode.Jaunty's
