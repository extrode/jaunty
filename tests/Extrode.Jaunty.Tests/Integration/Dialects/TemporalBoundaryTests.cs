...
public class TemporalBoundaryTests : IClassFixture<DialectFixture>
{
    ...
    /// <summary>
    /// The column is DATETIME2(7), whose floor is 0001-01-01, and the write still fails: Extrode.Jaunty
    ...
    /// a silent loss of up to 3.33ms on every DateTime Extrode.Jaunty writes to SQL Server.
    /// </summary>
    [Theory]
    [SqlServer]
