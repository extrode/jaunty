...
namespace Extrode.Jaunty.Tests.Integration.IDbConnectionFallback;
...
public class WriteFallbackTests : IDisposable
{
    ...
    /// SQLite's dialect and this works. It is the positive half of the fix: the throw proves Extrode.Jaunty
