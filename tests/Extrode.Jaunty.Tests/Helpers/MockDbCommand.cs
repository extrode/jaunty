...
/// dialects and type handlers on the global statics, so it stays in the serial Extrode.Jaunty.Tests
/// assembly - but twelve of the files that moved to the parallel Extrode.Jaunty.UnitTests use these mocks
