...
/// </para>
/// <para>
/// The values have to be captured during the call: Extrode.Jaunty disposes the command before returning and
...
/// <see cref="CommandType.StoredProcedure"/>, and the point is to observe what Extrode.Jaunty asked for.
/// </summary>
