...
// to the parallel Extrode.Jaunty.UnitTests assembly - but Integration/Read/QueryPartialListTests.cs
// stayed behind in the serial Extrode.Jaunty.Tests and uses SpyConnection. Both projects share this
...
/// that Extrode.Jaunty applied to it.
/// </summary>
...
/// <see cref="EmptyDataReader"/>, so tests can observe the <see cref="CommandType"/> Extrode.Jaunty sets
...
/// <see cref="System.Data.Common.DbTransaction"/>, so tests can prove Extrode.Jaunty assigns it to
