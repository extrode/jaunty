...
namespace Extrode.Jaunty.Tests.Unit.Read;

/// <remarks>
/// Shares the "Type Handler Operations" collection with
/// <see cref="Extrode.Jaunty.Tests.Unit.TypeHandlers.EnumStorageTests"/>,
/// <see cref="Extrode.Jaunty.Tests.Unit.TypeHandlers.TypeHandlerRegistryTests"/>, and
/// <see cref="Extrode.Jaunty.Tests.Integration.TypeHandlers.TypeHandlerRoundTripTests"/> —
...
public class ParameterBinderTests
{
    ...
    public void Bind_EmptyArray_WrappedMySqlDialect_UsesDualSubquery()
    {
        SqlDialectFactory.RegisterDialect("R27WrappedMySqlConnection",
            new global::Extrode.Jaunty.Extensions.Reflection.Dialects.MySqlDialectWithBulkCopy());
        var command = new MockDbCommand("SELECT * FROM products WHERE id IN @Ids")
        {
    ...
    {
        int ceiling = new global::Extrode.Jaunty.Dialects.SQLiteDialect().MaxParametersPerStatement;
