...
public class ConfigurationGenerationTests : IDisposable
{
    ...
    public void TheMultiRowInsertStatementFollowsAColumnNameResolverChange()
    {
        ...
        string before = global::Extrode.Jaunty.Internals.Write.MultiRowInsertCache.GetOrBuild(
    ...
    private static global::Extrode.Jaunty.Internals.Entity.EntityMetadata MetadataFor<T>() =>
        (global::Extrode.Jaunty.Internals.Entity.EntityMetadata)JauntyConfig.ReflectionTableMetadataResolver!.Invoke(typeof(T));
    ...
    public void NothingIsRebuiltWhileConfigurationIsUnchanged()
    {
        Action<IDbCommand, SteadyStateWidget>? first =
            global::Extrode.Jaunty.Internals.Write.WriteParameterCache<SteadyStateWidget>.InsertBinder;
