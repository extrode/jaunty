...
/// <see cref="Extrode.Jaunty.Tests.Unit.Interceptors.JauntyLoggingExtensionsTests"/>, and
/// <see cref="Extrode.Jaunty.Tests.Unit.Configuration.JauntyConfigInterceptorTests"/> — all mutate the same
...
public class WriteCoreInterceptorTests : IDisposable
{
    ...
    public void Update_WithRegisteredInterceptor_InvokesInterceptor()
    {
        ...
        seed.Id = id;
        seed.Name = "Updated";
        // SQLiteConnection declares its own "Update" event, which hides the Extrode.Jaunty.Update<T>
        // extension method from normal instance-member lookup - call it via the explicit static
        // form (namespace Extrode.Jaunty, class Jaunty) instead of _connection.Update(seed).
        int affected = global::Extrode.Jaunty.Jaunty.Update(_connection, seed);
    ...
    public async Task UpdateAsync_WithRegisteredInterceptor_InvokesInterceptor()
    {
        ...
        seed.Id = id;
        seed.Name = "Updated";
        int affected = await global::Extrode.Jaunty.Jaunty.UpdateAsync(_connection, seed);
