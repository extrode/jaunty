...
/// mapper when one exists, so merely adding or removing the <c>Extrode.Jaunty.SourceGenerator</c> package
...
/// <c>Extrode.Jaunty.SourceGenerator.Tests.GeneratedIdentityInferenceTests</c>.
/// </para>
///
/// <para>
