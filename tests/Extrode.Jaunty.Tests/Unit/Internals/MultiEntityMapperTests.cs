...
public class MultiEntityMapperTests : IDisposable
{
    ...
    public void Build_DisjointColumns_MapsBothTypes()
    {
        ...
        var mapper = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<OrderEntity, DetailEntity>.Build(reader);
    ...
    public void Build_OverlappingColumn_T1HasPriority()
    {
        ...
        var mapper = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<OverlapT1, OverlapT2>.Build(reader);
    ...
    public void Build_UnmatchedColumn_Ignored()
    {
        ...
        var mapper = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<EntityA, EntityB>.Build(reader);
    ...
    public void Build_ColumnAttribute_MapsViaColumnName()
    {
        ...
        var mapper = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<ColumnMappedT1, EntityB>.Build(reader);
    ...
    public void Apply_NullableProperty_NullValue_SetsNull()
    {
        ...
        var mapper = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<NullableT1, NullableT2>.Build(reader);
    ...
    public void Map_NonNullableValueTypeOnT2_NullThrows()
    {
        ...
        var mapper = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<NullableT1, NonNullableT2>.Build(reader);
    ...
    public void Build_Arity2_DifferentColumnSets_SameFieldCount_DoNotCollide()
    {
        ...
        // from the inner Extrode.Jaunty.Extensions.Reflection resolver's own cache.
        ...
        try
        {
            ...
            var mapperA = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<SchemaKeyPairT1, SchemaKeyPairT2>.Build(readerA);
            ...
            var mapperB = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<SchemaKeyPairT1, SchemaKeyPairT2>.Build(readerB);
    ...
    public void Build_Arity3_DifferentColumnSets_SameFieldCount_DoNotCollide()
    {
        ...
        //
        // The outer cache under test lives in Extrode.Jaunty.Internals.Read.MultiEntityMapperN.
        // The inner Extrode.Jaunty.Extensions.Reflection resolver has its own, separately scoped
        ...
        try
        {
            ...
            var mapperA = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<SchemaKeyColA, SchemaKeyColBC, SchemaKeyColC>.Build(readerA);
            ...
            var mapperB = global::Extrode.Jaunty.Internals.Read.MultiEntityMapper<SchemaKeyColA, SchemaKeyColBC, SchemaKeyColC>.Build(readerB);
    ...
    // (Extrode.Jaunty.Extensions.Reflection's, not the outer Extrode.Jaunty.Internals.Read cache tested above)
    ...
    public void Build_ReflectionLayerArity3_DifferentColumnSets_SameFieldCount_DoNotCollide()
    {
        ...
        // in Extrode.Jaunty.Extensions.Reflection.MultiEntityMapper<T1,T2,T3> (and arities 4-7, same
        ...
        // Extrode.Jaunty.Internals.Read cache, this test calls Build() on the Reflection-layer
        ...
        var mapperA = global::Extrode.Jaunty.Extensions.Reflection.MultiEntityMapper<ReflSchemaKeyColA, ReflSchemaKeyColBC, ReflSchemaKeyColC>.Build(readerA);
        ...
        var mapperB = global::Extrode.Jaunty.Extensions.Reflection.MultiEntityMapper<ReflSchemaKeyColA, ReflSchemaKeyColBC, ReflSchemaKeyColC>.Build(readerB);
    ...
    // Entities scoped to this scenario so the arity-2 Extrode.Jaunty.Extensions.Reflection.MultiEntityMapper<T1,T2>
    // static cache can't be warmed by any other test in the suite.
    ...
    public void Build_ReflectionLayerArity2_ReturnsWorkingMapper()
    {
        ...
        var mapper = global::Extrode.Jaunty.Extensions.Reflection.MultiEntityMapper<ReflArity2T1, ReflArity2T2>.Build(reader);
