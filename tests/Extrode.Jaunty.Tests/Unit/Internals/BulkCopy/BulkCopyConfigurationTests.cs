...
/// </summary>
/// <remarks>
/// Shares the "Write Operations" collection with <see cref="Extrode.Jaunty.Tests.Integration.Write.BulkCopyIntegrationTests"/>
/// (see <see cref="Extrode.Jaunty.Tests.Integration.Write.WriteOperationsCollection"/>) because both mutate the same
