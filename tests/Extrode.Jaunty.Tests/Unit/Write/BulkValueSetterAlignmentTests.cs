...
/// the mismatch, and that the aligned case - the only one a correctly-configured Extrode.Jaunty produces -
...
public class BulkValueSetterAlignmentTests
{
    ...
    /// <summary>
    /// A parameter collection Extrode.Jaunty did not build, standing in for the one a mismatched binder
