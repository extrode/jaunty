...
public class InsertCoreGuardTests : IDisposable
{
    ...
    public async Task WithNoMappingConfiguredAsync_TheBinderGuardNamesTheType()
    {
        ...
        // AUD-R35-099: Extrode.Jaunty's static constructor calls TryEnableReflectionMapping, and it runs on
        // the first touch of any Extrode.Jaunty static member - which, without this warm-up, is the very
