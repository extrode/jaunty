...
///
/// Mirrors tests/Extrode.Jaunty.Tests/Helpers/TestConfiguration.cs and reuses the same env var
/// names, so CI's existing SQL Server service container (which sets JAUNTY_TEST_SQLSERVER
/// for Extrode.Jaunty.Tests) also enables SqlServerSchemaReaderTests here with no workflow changes.
/// </summary>
