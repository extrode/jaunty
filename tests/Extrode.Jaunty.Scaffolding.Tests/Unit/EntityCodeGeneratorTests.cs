...
public class EntityCodeGeneratorTests
{
    ...
    public void GenerateEntity_NoTableAttribute_OmitsTableAttribute()
    {
        ...
        Assert.DoesNotContain("Extrode.Jaunty.Attributes.Table(", code);
    }
    ...
    public void GenerateEntity_NoColumnAttribute_OmitsColumnAttribute()
    {
        ...
        Assert.DoesNotContain("Extrode.Jaunty.Attributes.Column(", code);
    }
    ...
    public void GenerateEntity_NoDatabaseGeneratedAttribute_OmitsDatabaseGeneratedAttribute()
    {
        ...
        Assert.DoesNotContain("Extrode.Jaunty.Attributes.DatabaseGenerated(", code);
    }
    ...
    {
        // Extrode.Jaunty's [Table]/[Column]/[Key]/[DatabaseGenerated] attributes are emitted fully
        // qualified rather than via "using Extrode.Jaunty.Attributes;", so the generated file never
    ...
    public void GenerateEntity_WithDataAnnotationsAndDefaultAttributeFlags_DoesNotEmitAmbiguousUsings()
    {
        ...
        // "using Extrode.Jaunty.Attributes;" and "using System.ComponentModel.DataAnnotations(.Schema);"
