...
public class ScaffoldGeneratorCompositionTests
{
    ...
    private static (ImmutableArray<Diagnostic> Diagnostics, int GeneratedFiles) RunGeneratorAndCompile(string source)
    {
        ...
        // referenced Extrode.Jaunty assembly is the net8.0 build. Without the symbol the generated source
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            [new global::Extrode.Jaunty.SourceGenerator.JauntyGenerator().AsSourceGenerator()],
    ...
    private static IEnumerable<MetadataReference> ReferenceAssemblies()
    {
        ...
        // way to give the in-memory compilation the BCL plus Extrode.Jaunty without hardcoding paths.
        var loaded = AppDomain.CurrentDomain.GetAssemblies()
            .Where(a => !a.IsDynamic && !string.IsNullOrEmpty(a.Location))
            .Select(a => a.Location);

        var jaunty = typeof(global::Extrode.Jaunty.Attributes.TableAttribute).Assembly.Location;
