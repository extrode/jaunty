...
/// <summary>
/// AUD-R26-055 (batch 4, low/consistency). <c>Extrode.Jaunty.Init.TryEnableReflectionMapping</c>'s
...
/// healthy case: the suite runs with Extrode.Jaunty.Extensions.Reflection present, so a non-null value here
