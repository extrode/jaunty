...
public class DocumentedApiTests
{
    ...
    [
        "/docs/99-archive/", "/docs/_plans/", "/docs/_specs/", "/docs/_decisions/",
    ...
    {
        Type config = typeof(global::Extrode.Jaunty.Configuration.JauntyConfig);
    ...
    {
        int before = global::Extrode.Jaunty.Internals.ConfigurationGeneration.Current;

        global::Extrode.Jaunty.Internals.ConfigurationGeneration.Invalidate();
