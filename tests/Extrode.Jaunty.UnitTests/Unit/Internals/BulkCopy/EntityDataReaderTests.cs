...
using Extrode.Jaunty.Internals.BulkCopy;
using Extrode.Jaunty.Internals.Entity;

namespace Extrode.Jaunty.Tests.Unit.Internals.BulkCopy;
...
public class EntityDataReaderTests : IDisposable
{
    ...
    // column-name lookup in Extrode.Jaunty is deliberately case-insensitive. A caller resolving a
    ...
    // handed to third-party provider bulk-copy APIs whose lookup behaviour Extrode.Jaunty does not control.
