...
/// <summary>
/// AUD-R26-062 (round 26, batch 6, low/consistency). Extrode.Jaunty had three terminal "raw ADO.NET value to
/// CLR type" converters - <c>DbValueConverter.ChangeType</c> (Extrode.Jaunty.Extensions.Reflection),
/// <c>GroupedJoinedResultMapper.ConvertColumnValue</c> (Extrode.Jaunty.Fluent) and
/// <c>ScalarConverter&lt;T&gt;.Convert</c> (Extrode.Jaunty) - which agreed on culture and on enums and
