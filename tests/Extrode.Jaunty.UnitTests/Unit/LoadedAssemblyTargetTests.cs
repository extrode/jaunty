...
/// <summary>
/// Spec 010 (T13). Asserts the <c>Extrode.Jaunty.dll</c> this test leg actually loaded was <em>compiled</em>
...
public class LoadedAssemblyTargetTests
{
...
#else
        Assert.Fail($"Unpinned test TFM loaded Extrode.Jaunty compiled as '{tfm}' - add the expected pin here.");
#endif
    }
    ...
    {
        // Owed by T9: ASYNC_ENUMERABLE_SUPPORT is defined for every Extrode.Jaunty build (ns2.0 via
