...
/// batch-sizing hint, Extrode.Jaunty refused <c>IN</c>-clause expansions the provider ran without
...
public class SqliteParameterCeilingTests
{
    ...
    /// <summary>
    /// The guard still guards. Past the real ceiling Extrode.Jaunty says so in its own words, rather than
