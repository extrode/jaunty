...
/// would mean installing <c>Extrode.Jaunty.Extensions.Reflection</c> silently reintroduces the comparison
...
public class DecimalBindingDialectTests
{
    private static List<Type> ShippingDialects()
    {
        Assembly[] shipping =
        [
            typeof(ISqlDialect).Assembly,                                   // Extrode.Jaunty
            typeof(global::Extrode.Jaunty.Extensions.Reflection.JauntyReflectionExtensions).Assembly,
        ];
