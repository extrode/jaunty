...
/// enforces that: adding a <c>PackageReference</c> to <c>src/Extrode.Jaunty</c> succeeds silently and the
...
public class PackageDependencyTests
{
    ...
    private const string LoggingProject = "src/Extrode.Jaunty.Extensions.Logging/Extrode.Jaunty.Extensions.Logging.csproj";
