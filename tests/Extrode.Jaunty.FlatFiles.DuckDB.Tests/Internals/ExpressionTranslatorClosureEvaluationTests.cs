...
///
/// <para>
/// This was the eighth byte-identical copy of the helper; the seven in Extrode.Jaunty.Fluent now share
/// <c>ExpressionEvaluator</c>. This one stays duplicated because the assemblies are independent -
/// Extrode.Jaunty.FlatFiles.DuckDB does not reference Extrode.Jaunty.Fluent - so it needs its own coverage.
/// </para>
///
/// <para>
