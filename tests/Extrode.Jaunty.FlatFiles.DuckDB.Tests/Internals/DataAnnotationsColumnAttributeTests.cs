...
using JauntyColumn = Extrode.Jaunty.Attributes.ColumnAttribute;
using JauntyKey = Extrode.Jaunty.Attributes.KeyAttribute;
...
/// <c>Extrode.Jaunty.Attributes.ColumnAttribute</c> only, so an entity annotated with
