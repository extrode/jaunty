...
namespace Extrode.Jaunty.FlatFiles.DuckDB.Tests.Unit;
...
///
/// <para>
/// The finding's own conclusion was that this, batch 5's identical finding against Extrode.Jaunty.Fluent
...
public class DuckDbObservabilityTests : IDisposable
{
    ...
    private void AssertObserved(string what)
    {
        Assert.True(_interceptor.Executing > 0,
            ...
            "Extrode.Jaunty.FlatFiles.DuckDB used to open every command directly, bypassing the pipeline entirely.");
