...
public class ForeignTableAttributeTests
{
    ...
    [Theory]
    [InlineData("""[Foreign.Table("wrong_table", Schema = "wrong_schema")]""", """[Extrode.Jaunty.Attributes.Table("orders", "sales")]""")]
    [InlineData("""[Extrode.Jaunty.Attributes.Table("orders", "sales")]""", """[Foreign.Table("wrong_table", Schema = "wrong_schema")]""")]
