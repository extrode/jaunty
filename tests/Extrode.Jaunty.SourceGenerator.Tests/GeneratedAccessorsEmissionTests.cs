...
public class GeneratedAccessorsEmissionTests
{
    ...
    /// <summary>
    /// A class with a base list that has nothing to do with Extrode.Jaunty must not trip the check - the
    ...
    /// <summary>
    /// Everything already loaded, plus Extrode.Jaunty itself - the same approach as
    ...
    private static IEnumerable<MetadataReference> ReferenceAssemblies()
    {
        ...
        [
            ...
            typeof(global::Extrode.Jaunty.Interfaces.IGeneratedAccessors<>).Assembly.Location,
