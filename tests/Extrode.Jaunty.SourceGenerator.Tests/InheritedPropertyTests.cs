...
public class InheritedPropertyTests
{
    ...
    /// <see cref="GeneratorCachingTests"/>. Without the explicit Extrode.Jaunty reference the [Table]
    ...
    private static IEnumerable<MetadataReference> ReferenceAssemblies()
    {
        ...
        string[] required = [typeof(global::Extrode.Jaunty.Attributes.TableAttribute).Assembly.Location];
