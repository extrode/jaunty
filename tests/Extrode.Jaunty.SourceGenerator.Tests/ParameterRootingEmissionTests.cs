...
/// <summary>
/// Spec 011. Extrode.Jaunty binds a parameters object by reflecting over its public properties, and on a
...
/// parameters object is not an entity, is usually anonymous, and Extrode.Jaunty has never been told about it.
///
/// <para>
...
public class ParameterRootingEmissionTests
{
    ...
    public void AnAnonymousParametersObject_IsRootedByAStructurallyIdenticalWitness()
    {
        ...
        Assert.Contains(
            "global::Extrode.Jaunty.JauntyAot.PreserveParameters(new { Id = default(int) });",
            generated,
    ...
    public void ANamedParametersType_IsRootedByName()
    {
        ...
        Assert.Contains(
            "global::Extrode.Jaunty.JauntyAot.PreserveParameters<global::RootProbe.DataAccess.ProductQuery>();",
            generated,
            StringComparison.Ordinal);
    }
    ...
    /// reporting JAUNTYGEN003 against Extrode.Jaunty's own source.
    /// </summary>
    [Theory]
    ...
    /// rooting for types that never reach Extrode.Jaunty at all.
    /// </summary>
    [Fact]
    ...
    /// Measured while building this - without the exclusion it fired 170 times inside Extrode.Jaunty's own
    ...
    /// type parameter - until it was measured against the library: Extrode.Jaunty's own generic write plumbing
    ...
    /// that threw with an empty property list. The stubs live in a <c>Extrode.Jaunty.Fluent</c> namespace
    ...
    public void TheFluentParameterBindingCalls_AreRootedToo(string call)
    {
        ...
        Assert.Contains(
            "global::Extrode.Jaunty.JauntyAot.PreserveParameters(new { Name = default(string) });",
            generated,
            StringComparison.Ordinal);
    }
    ...
    /// <c>new { Ids = ids }</c>, the idiomatic shape for Extrode.Jaunty's own IN-clause expansion, rooted
    ...
    private static IEnumerable<MetadataReference> ReferenceAssemblies()
    {
        ...
        string[] required =
        [
            typeof(global::Extrode.Jaunty.Attributes.TableAttribute).Assembly.Location,
            typeof(global::Extrode.Jaunty.JauntyAot).Assembly.Location,
