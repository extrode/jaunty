...
namespace Extrode.Jaunty.SourceGenerator.Tests.Entities.ForeignAttributes
{
...
namespace Extrode.Jaunty.SourceGenerator.Tests.Entities
{
    ...
    // bind, and Extrode.Jaunty's [EnumStorage] still reaches the generated metadata.
    ...
    public partial class GenRecognizedAttributeEntity : IMapped<GenRecognizedAttributeEntity>
    {
        ...
        [EnumStorage(global::Extrode.Jaunty.Attributes.EnumStorage.String)]
        public GenForeignGrade Grade { get; set; }
    }
}
