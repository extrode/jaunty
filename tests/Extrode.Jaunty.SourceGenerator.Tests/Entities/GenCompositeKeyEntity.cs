...
// Modelled on Extrode.Jaunty.Tests.Entities.OrderDetail, which is the real composite-key entity in the
// suite and is `partial` - it would have hit exactly this the moment Extrode.Jaunty.Tests gained the
// generator.
