...
public class GeneratorCachingTests
{
    ...
    public void AForeignAttributeNamedTableAttribute_IsNoLongerRecognized()
    {
        ...
        // themselves for an unrelated purpose, marked a class as a Extrode.Jaunty entity and got a mapper
    ...
    public void AnAliasedTableAttribute_IsStillRecognized()
    {
        ...
        (GeneratorDriver driver, _) = RunFirst("""
            using JauntyTable = Extrode.Jaunty.Attributes.TableAttribute;
    ...
    {
        // Everything already loaded, plus Extrode.Jaunty itself. Simplest reliable way to give the in-memory
