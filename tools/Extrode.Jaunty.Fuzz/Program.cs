...
namespace Extrode.Jaunty.Fuzz;

/// <summary>
/// libFuzzer harness for <see cref="SqlParameterParser.ExtractParameterNames"/>, the span-based
/// walker that runs on every query Extrode.Jaunty executes with parameters. The oracle is total-ness plus
...
/// <c>dotnet Extrode.Jaunty.Fuzz.dll</c>, SharpFuzz finds none of the IPC environment variables and
/// replays args[1] as a single file instead of fuzzing.
/// <code>
///   dotnet publish tools/Extrode.Jaunty.Fuzz -c Release -o out/fuzz
///   sharpfuzz out/fuzz/Extrode.Jaunty.dll
///   ./libfuzzer-dotnet -max_total_time=600 --target_path="$(command -v dotnet)" \
///     --target_arg=out/fuzz/Extrode.Jaunty.Fuzz.dll tools/Extrode.Jaunty.Fuzz/corpus
/// </code>
/// </para>
///
/// <para>
