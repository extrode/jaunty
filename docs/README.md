...
- **[reports/](reports/)** - dated, point-in-time snapshots, never revised in place
  - [Production Readiness Report](reports/production-readiness-2026-07-02.md)
  - [Coverage Gap Inventory](reports/coverage-gaps-2026-07-04.md)
  - [Benchmarks](reports/benchmarks-2026-09-02.md) - four providers against a corrected
    hand-coded baseline; earlier reports [2026-07-29](reports/benchmarks-2026-07-29.md)
    and [2026-07-04](reports/benchmarks-2026-07-04.md)
...
- **[site-design/](site-design/README.md)**
  - [`jaunty-docs-app.dc.html`](site-design/jaunty-docs-app.dc.html) - Primary design (authoritative layout target)
  - [`jaunty-docs.dc.html`](site-design/jaunty-docs.dc.html) - Secondary design reference
  - [`support.js`](site-design/support.js) - Design-tool runtime (view `.dc.html` files in browser)
...
`scripts/build-docs.sh` runs the shared `Docs` tool (sibling repo `../docs`), which converts this markdown tree into a self-contained static HTML site matching the design in `site-design/`. Page layout, CSS, and nav JS are generated by the tool itself, not read from this repo. The tool is not part of this repository, so the script runs only for maintainers with that sibling checkout; the rendered site is committed under `dist/docs-site/`.
...
**Design tokens** and implementation details are documented in [`site-design/README.md`](site-design/README.md).
...
- **[assets/](assets/README.md)** - Screenshots, diagrams, and other media
