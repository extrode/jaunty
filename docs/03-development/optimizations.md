...
- **Target Files**: `src/Extrode.Jaunty/Internals/Write/InsertCore.cs`, `UpdateCore.cs`
...
- **Target Files**: `src/Extrode.Jaunty/Internals/Write/InsertCore.cs` (`PopulateEntityId` method)
...
- **Target Files**: `src/Extrode.Jaunty/Internals/Parameters/ParameterBinder.cs` (`IsCollection` and `ExpandCollectionParameters`)
...
- **Target Files**: `src/Extrode.Jaunty/Internals/Entity/MetadataCache.cs` (`CreateSetter` method)
...
- **Target Files**: `src/Extrode.Jaunty/Internals/MultiEntityMapper.cs`, `src/Extrode.Jaunty/Internals/QueryCore.cs`
...
- **Target Files**: `src/Extrode.Jaunty/Internals/Parameters/SqlParameterParser.cs`
...
- **Target Files**: `src/Extrode.Jaunty/Internals/Entity/MetadataCache.cs` (`GetSetters` method)
