...
Jaunty and JauntyQ are commercial, source-available products. A subscription buys access to the private release feed, updates, and support; both products carry a 30-day full-featured trial.
...
- **Individual** - private feed access for one named developer, all updates during the term, community-channel support. For personal and solo-professional projects.
- **Company** - per-seat feed access, priority email support, and read-only source repository access at 10+ seats. Seats are named developers and can be reassigned.
...
- **Source access** (Company 10+ and Enterprise tiers) is governed by the **Islamic Software License - Restricted (ISL-R)**: source is provided for transparency, inspection, and audit - not for modification or redistribution.
