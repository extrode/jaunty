...
-- Bootstraps the Northwind test database for mysql integration tests.
...
ALTER TABLE `region` ADD COLUMN `RegionId` int AS (`region_id`);
...
ALTER TABLE `territories` ADD COLUMN `TerritoryId` varchar(20) AS (`territory_id`);
ALTER TABLE `territories` ADD COLUMN `RegionId` int AS (`region_id`);
...
ALTER TABLE `customer_demographics` ADD COLUMN `CustomerTypeId` char(10) AS (`customer_type_id`);
ALTER TABLE `customer_demographics` ADD COLUMN `CustomerDescription` text AS (`customer_description`);
...
ALTER TABLE `customers` ADD COLUMN `CustomerId` char(5) AS (`customer_id`);
ALTER TABLE `customers` ADD COLUMN `CompanyName` varchar(40) AS (`company_name`);
ALTER TABLE `customers` ADD COLUMN `ContactName` varchar(30) AS (`contact_name`);
ALTER TABLE `customers` ADD COLUMN `ContactTitle` varchar(30) AS (`contact_title`);
ALTER TABLE `customers` ADD COLUMN `PostalCode` varchar(10) AS (`postal_code`);
...
ALTER TABLE `customer_customer_demo` ADD COLUMN `CustomerId` char(5) AS (`customer_id`);
ALTER TABLE `customer_customer_demo` ADD COLUMN `CustomerTypeId` char(10) AS (`customer_type_id`);
...
CREATE TABLE employees (
    ...
    -- CONSTRAINT ck_employees_birth_date CHECK (birth_date < datetime('now')),
    CONSTRAINT fk_employees__employees FOREIGN KEY (reports_to) REFERENCES employees (employee_id)
);
ALTER TABLE `employees` ADD COLUMN `EmployeeId` int AS (`employee_id`);
ALTER TABLE `employees` ADD COLUMN `LastName` varchar(20) AS (`last_name`);
ALTER TABLE `employees` ADD COLUMN `FirstName` varchar(10) AS (`first_name`);
ALTER TABLE `employees` ADD COLUMN `TitleOfCourtesy` varchar(25) AS (`title_of_courtesy`);
ALTER TABLE `employees` ADD COLUMN `BirthDate` datetime AS (`birth_date`);
ALTER TABLE `employees` ADD COLUMN `HireDate` datetime AS (`hire_date`);
ALTER TABLE `employees` ADD COLUMN `PostalCode` varchar(10) AS (`postal_code`);
ALTER TABLE `employees` ADD COLUMN `HomePhone` varchar(24) AS (`home_phone`);
ALTER TABLE `employees` ADD COLUMN `ReportsTo` int AS (`reports_to`);
ALTER TABLE `employees` ADD COLUMN `PhotoPath` varchar(255) AS (`photo_path`);
...
ALTER TABLE `employee_territories` ADD COLUMN `EmployeeId` int AS (`employee_id`);
ALTER TABLE `employee_territories` ADD COLUMN `TerritoryId` varchar(20) AS (`territory_id`);
...
ALTER TABLE `categories` ADD COLUMN `CategoryId` int AS (`category_id`);
ALTER TABLE `categories` ADD COLUMN `CategoryName` varchar(15) AS (`category_name`);
...
ALTER TABLE `suppliers` ADD COLUMN `SupplierId` int AS (`supplier_id`);
ALTER TABLE `suppliers` ADD COLUMN `CompanyName` varchar(40) AS (`company_name`);
ALTER TABLE `suppliers` ADD COLUMN `ContactName` varchar(30) AS (`contact_name`);
ALTER TABLE `suppliers` ADD COLUMN `ContactTitle` varchar(30) AS (`contact_title`);
ALTER TABLE `suppliers` ADD COLUMN `PostalCode` varchar(10) AS (`postal_code`);
ALTER TABLE `suppliers` ADD COLUMN `HomePage` text AS (`home_page`);
...
CREATE TABLE products (
    ...
    discontinued            tinyint(1)         NOT NULL    DEFAULT FALSE,
...
ALTER TABLE `products` ADD COLUMN `ProductId` int AS (`product_id`);
ALTER TABLE `products` ADD COLUMN `ProductName` varchar(40) AS (`product_name`);
ALTER TABLE `products` ADD COLUMN `SupplierId` int AS (`supplier_id`);
ALTER TABLE `products` ADD COLUMN `CategoryId` smallint AS (`category_id`);
ALTER TABLE `products` ADD COLUMN `QuantityPerUnit` varchar(20) AS (`quantity_per_unit`);
ALTER TABLE `products` ADD COLUMN `UnitPrice` decimal(19,4) AS (`unit_price`);
ALTER TABLE `products` ADD COLUMN `UnitsInStock` smallint AS (`units_in_stock`);
ALTER TABLE `products` ADD COLUMN `UnitsOnOrder` smallint AS (`units_on_order`);
ALTER TABLE `products` ADD COLUMN `ReorderLevel` smallint AS (`reorder_level`);
...
ALTER TABLE `shippers` ADD COLUMN `ShipperId` int AS (`shipper_id`);
ALTER TABLE `shippers` ADD COLUMN `CompanyName` varchar(40) AS (`company_name`);
...
ALTER TABLE `orders` ADD COLUMN `OrderId` int AS (`order_id`);
ALTER TABLE `orders` ADD COLUMN `CustomerId` char(5) AS (`customer_id`);
ALTER TABLE `orders` ADD COLUMN `EmployeeId` int AS (`employee_id`);
ALTER TABLE `orders` ADD COLUMN `OrderDate` datetime AS (`order_date`);
ALTER TABLE `orders` ADD COLUMN `RequiredDate` datetime AS (`required_date`);
ALTER TABLE `orders` ADD COLUMN `ShippedDate` datetime AS (`shipped_date`);
ALTER TABLE `orders` ADD COLUMN `ShipVia` int AS (`ship_via`);
ALTER TABLE `orders` ADD COLUMN `ShipName` varchar(40) AS (`ship_name`);
ALTER TABLE `orders` ADD COLUMN `ShipAddress` varchar(60) AS (`ship_address`);
ALTER TABLE `orders` ADD COLUMN `ShipCity` varchar(15) AS (`ship_city`);
ALTER TABLE `orders` ADD COLUMN `ShipRegion` varchar(15) AS (`ship_region`);
ALTER TABLE `orders` ADD COLUMN `ShipPostalCode` varchar(10) AS (`ship_postal_code`);
ALTER TABLE `orders` ADD COLUMN `ShipCountry` varchar(15) AS (`ship_country`);
...
ALTER TABLE `order_details` ADD COLUMN `OrderId` int AS (`order_id`);
ALTER TABLE `order_details` ADD COLUMN `ProductId` int AS (`product_id`);
ALTER TABLE `order_details` ADD COLUMN `UnitPrice` decimal(19,4) AS (`unit_price`);
...
(5, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '1955-03-04', '1993-10-17', '14 Garrett Hill', 'London', NULL, 'SW1 8JR', 'UK', '(71) 555-4848', '3453', X'', 'Steven Buchanan graduated from St. Andrews University,  Scotland,  with a BSC degree in 1976.  Upon joining the company as a sales representative in 1992,  he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London.  He was promoted to sales manager in March 1993.  Mr. Buchanan has completed the courses [Successful Telemarketing] and [International Sales Management.]  He is fluent in French.', 2, 'http://accweb/emmployees/buchanan.bmp'),
...
(1, 'Beverages', 'Soft drinks,  coffees,  teas,  beers,  and ales', X''),
(2, 'Condiments', 'Sweet and savory sauces,  relishes,  spreads,  and seasonings', X''),
...
(4, 'Dairy Products', 'Cheeses', X''),
...
(6, 'Meat/Poultry', 'Prepared meats', X''),
(7, 'Produce', 'Dried fruit and bean curd', X''),
(8, 'Seafood', 'Seaweed and fish', X'');
