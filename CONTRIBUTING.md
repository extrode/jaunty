...
not let you publish a modified Jaunty as your own product; that stays prohibited.
...
#### How Jaunty adopts the ISL-CLA

Jaunty adopts the **ISL-CLA, Version 1.1**, by reference. The text is reproduced whole and
...
assistant or language model is not accepted — see [CLA.md](CLA.md) Section 6, which Jaunty adopts,
...
Agreement, Version 1.1 (CLA.md), as adopted by Jaunty in CONTRIBUTING.md,
