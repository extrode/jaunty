...
public class TpcAggregationBenchmarks
{
    ...
    public void Setup()
    {
        ...
        if (count == 0)
            throw new InvalidOperationException(
                "No TPC-H data found. Run: dotnet run --project benchmarks/Extrode.Jaunty.Benchmarks -- --setup --provider Sqlite");
    }
    ...
    [Benchmark(Description = "Extrode.Jaunty COUNT(*) orders")]
    ...
    [Benchmark(Description = "Extrode.Jaunty SUM orders")]
    ...
    [Benchmark(Description = "Extrode.Jaunty GROUP BY lineitem")]
