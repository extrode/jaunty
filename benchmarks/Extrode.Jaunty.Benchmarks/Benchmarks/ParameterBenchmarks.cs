...
/// <summary>
/// Extrode.Jaunty-specific benchmark comparing parameter binding strategies.
/// </summary>
public class ParameterBenchmarks
{
    ...
    [Benchmark(Description = "Extrode.Jaunty named param (anon obj)", Baseline = true)]
    ...
    [Benchmark(Description = "Extrode.Jaunty positional param")]
