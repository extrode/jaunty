...
/// Tests Extrode.Jaunty's native bulk copy (SqlBulkCopy, COPY FROM, LOAD DATA INFILE)
...
public class BulkCopyBenchmarks
{
    ...
    public void Setup()
    {
        ...
        // Enable native bulk copy for Extrode.Jaunty with a low threshold so it always activates
    ...
    // --- Extrode.Jaunty BulkInsert (native bulk copy enabled) ---

    [Benchmark(Description = "Extrode.Jaunty BulkInsert (native)")]
