...
namespace Extrode.Jaunty.Benchmarks.Benchmarks;
...
public class QueryBenchmarks
{
    ...
    [Benchmark(Description = "Extrode.Jaunty Query<T>")]
    ...
    [Benchmark(Description = "Extrode.Jaunty Query<T> (WithExpectedRowCount)")]
    ...
    // is Extrode.Jaunty's pipeline overhead with mapping taken out of the comparison.
    ...
    [Benchmark(Description = "Extrode.Jaunty Query<T> (custom mapper)")]
    ...
    // differ only in what Extrode.Jaunty adds around the loop.
    [Benchmark(Description = "Extrode.Jaunty Query<T> (custom mapper, WithExpectedRowCount)")]
    ...
    // (docs/decisions 013). The other providers store a real decimal and GetDouble would throw, so there Setup
    ...
    [Benchmark(Description = "Extrode.Jaunty Query<T> (custom mapper, GetDouble)")]
    ...
    [Benchmark(Description = "Extrode.Jaunty Query<T> (custom mapper, GetDouble, WithExpectedRowCount)")]
